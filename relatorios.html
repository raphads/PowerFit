        ...
        <section class="content" name="content">
            ...
            <form id="equipForm">
                <select id="relatorio" name="relatorio">
                    <option value="rmensal">Receita Mensal</option>
                    <option value="daberto">Débitos em Aberto</option>
                    <option value="ainad">Alunos Inadimplentes</option>
                    <option value="ccresc"> Comparativo de Crescimento</option>
                </select>
                
                <button type="submit" onclick="Redirecionar()">PDF</button>&nbsp;<button type="submit" onclick="Redirecionar()">Excel</button>
    </form>
</section>
    <footer>
